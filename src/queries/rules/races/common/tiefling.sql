...
VALUES ("Tiefling", (SELECT id FROM source_types WHERE name = "Race"));
...
VALUES ("Bloodline of Asmodeus", (SELECT id FROM sources WHERE name = "Tiefling"), (SELECT id FROM source_types WHERE name = "Race"));
