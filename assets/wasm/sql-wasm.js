    ...
    initSqlJsPromise = new Promise(function (resolveModule, reject) {
        ...
        f.onRuntimeInitialized = function () {
            ...
            function b(g, l) {
                for (var n = [], t = 0; t < g; t += 1) {
                    ...
                    if (1 === A || 2 === A) w = kc(w);
                        ...
                        w = mc(A);
                        A = nc(A);
                        for (var N = new Uint8Array(w), M = 0; M < w; M += 1)
                            N[M] = p[A + M];
                        w = N;
                    } else w = null;
                    n.push(w);
            ...
            var h = y(4),
                ...
                nb = k("sqlite3_prepare_v2", "number", [
                    "number",
                    "number",
                    "number",
                    "number",
                ...
                qc = k("sqlite3_bind_double", "number", [
                    "number",
                    "number",
                    "number",
                ]),
                rc = k("sqlite3_bind_int", "number", [
                    "number",
                    "number",
                    "number",
                ]),
                sc = k("sqlite3_bind_parameter_index", "number", [
                    "number",
                    "string",
                ]),
                ...
                hc = k("sqlite3_result_text", "", [
                    "number",
                    "string",
                    "number",
                    "number",
                ]),
                ic = k("sqlite3_result_blob", "", [
                    "number",
                    "number",
                    "number",
                    "number",
                ...
                rb = k("sqlite3_aggregate_context", "number", [
                    "number",
                    "number",
                ]),
            ...
            c.prototype.getBlob = function (g) {
                ...
                var l = zc(this.Ka, g);
                g = yc(this.Ka, g);
                for (var n = new Uint8Array(l), t = 0; t < l; t += 1)
                    n[t] = p[g + t];
                return n;
            };
            ...
            c.prototype.getColumnNames = function () {
                for (var g = [], l = vc(this.Ka), n = 0; n < l; n += 1)
                    g.push(Bc(this.Ka, n));
                return g;
            };
            ...
            e.prototype.close = function () {
                null !== this.db &&
                    (Object.values(this.Ya).forEach(function (g) {
                        g.free();
                    }),
                    Object.values(this.Ma).forEach(wa),
                    (this.Ma = {}),
            ...
            e.prototype.create_function = function (g, l) {
                Object.prototype.hasOwnProperty.call(this.Ma, g) &&
                    (wa(this.Ma[g]), delete this.Ma[g]);
            ...
            e.prototype.create_aggregate = function (g, l) {
                ...
                var A = {};
                Object.hasOwnProperty.call(this.Ma, g) &&
                    (wa(this.Ma[g]), delete this.Ma[g]);
                l = g + "__finalize";
                Object.hasOwnProperty.call(this.Ma, l) &&
                    (wa(this.Ma[l]), delete this.Ma[l]);
                ...
                this.Ma[l] = M;
                this.handleError(
                    qb(this.db, g, w.length - 1, 1, 0, 0, N, M, 0)
                );
                return this;
            };
            f.Database = e;
        ...
        function bb(a, b) {
            ...
            "function" != typeof fetch
                ...
                : fetch(c, { credentials: "same-origin" }).then((d) =>
                      WebAssembly.instantiateStreaming(d, a).then(
                          b,
                          function (e) {
        ...
        var Q = {
                ...
                createNode(a, b, c, d) {
                    ...
                    R(c.mode)
                        ? ((c.Fa = Q.Pa.dir.node),
                          (c.Ga = Q.Pa.dir.stream),
                          (c.Ha = {}))
                        : 32768 === (c.mode & 61440)
                        ? ((c.Fa = Q.Pa.file.node),
                          (c.Ga = Q.Pa.file.stream),
                          (c.La = 0),
                          (c.Ha = null))
                        : 40960 === (c.mode & 61440)
                        ? ((c.Fa = Q.Pa.link.node), (c.Ga = Q.Pa.link.stream))
                        : 8192 === (c.mode & 61440) &&
                          ((c.Fa = Q.Pa.ob.node), (c.Ga = Q.Pa.ob.stream));
                ...
                Ga: {
                    ...
                    write(a, b, c, d, e, h) {
                        ...
                        if (b.subarray && (!a.Ha || a.Ha.subarray)) {
                            if (h)
                                return (
                                    (a.Ha = b.subarray(c, c + d)), (a.La = d)
                                );
                            if (0 === a.La && 0 === e)
                                return (a.Ha = b.slice(c, c + d)), (a.La = d);
                            if (e + d <= a.La)
                                return a.Ha.set(b.subarray(c, c + d), e), d;
                        }
                        zb(a, e + d);
                        if (a.Ha.subarray && b.subarray)
                            a.Ha.set(b.subarray(c, c + d), e);
            ...
            Rc = () => {
                if (!Qc) {
                    var a = {
                        ...
                        b;
                    for (b in Pc)
                        void 0 === Pc[b] ? delete a[b] : (a[b] = Pc[b]);
                    var c = [];
        ...
        var Vc = {
                ...
                g: function (a) {
                    try {
                        var b = U(a).node;
                        var c =
                            "string" == typeof b ? T(b, { Ra: !0 }).node : b;
                    ...
                    try {
                        return (
                            ...
                            0 === c
                                ...
                                : 512 === c
                                ? Yb(b)
                                : G("Invalid flags passed to unlinkat"),
                            0
                        );
                    } catch (d) {
                        if ("undefined" == typeof W || "ErrnoError" !== d.name)
                ...
                y: (a, b, c, d) => {
                    ...
                    b = (k) => {
                        ...
                        return `UTC${0 <= k ? "-" : "+"}${String(
                            Math.floor(r / 60)
                        ).padStart(2, "0")}${String(r % 60).padStart(2, "0")}`;
                    };
                    a = b(h);
                    b = b(e);
                    e < h
                        ? (q(a, u, c, 17), q(b, u, d, 17))
                        : (q(a, u, d, 17), q(b, u, c, 17));
                },
                d: () => Date.now(),
                s: () => 2147483648,
                c: () => performance.now(),
        ...
        f._sqlite3_exec = (a, b, c, d, e) =>
            (f._sqlite3_exec = Z.Q)(a, b, c, d, e);
        ...
        f._sqlite3_column_blob = (a, b) =>
            (f._sqlite3_column_blob = Z.ka)(a, b);
        f._sqlite3_column_bytes = (a, b) =>
            (f._sqlite3_column_bytes = Z.la)(a, b);
        ...
        f._sqlite3_bind_int = (a, b, c) =>
            (f._sqlite3_bind_int = Z.pa)(a, b, c);
        ...
        f._sqlite3_normalized_sql = (a) =>
            (f._sqlite3_normalized_sql = Z.ta)(a);
        ...
        f._RegisterExtensionFunctions = (a) =>
            (f._RegisterExtensionFunctions = Z.Aa)(a);
            ...
            function a() {
                if (!Wc && ((Wc = !0), (f.calledRun = !0), !Ka)) {
                    f.noFSInit ||
                        ...
                        f.stdin
                            ? Fc("stdin", f.stdin)
                            : Xb("/dev/tty", "/dev/stdin"),
                        f.stdout
                            ? Fc("stdout", null, f.stdout)
                            : Xb("/dev/tty", "/dev/stdout"),
                        f.stderr
                            ? Fc("stderr", null, f.stderr)
                            : Xb("/dev/tty1", "/dev/stderr"),
                        na("/dev/stdin", 0),
                        na("/dev/stdout", 1),
                        na("/dev/stderr", 1));
                    Jb = !1;
